...
ALTER TABLE balance_ledger ADD COLUMN input_tokens  INTEGER NOT NULL DEFAULT 0;
ALTER TABLE balance_ledger ADD COLUMN output_tokens INTEGER NOT NULL DEFAULT 0;
ALTER TABLE balance_ledger ADD COLUMN cached_tokens INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE model_pricing ADD COLUMN input_price        INTEGER NOT NULL DEFAULT 0;
ALTER TABLE model_pricing ADD COLUMN output_price       INTEGER NOT NULL DEFAULT 0;
-- NULL means "cached input billed at the normal input rate".
ALTER TABLE model_pricing ADD COLUMN cached_input_price INTEGER NULL;
...
UPDATE app_settings
   SET v = CAST(CAST(v AS INTEGER) * 500 AS TEXT)
